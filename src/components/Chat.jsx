...
const Chat = () => {
    ...
    useEffect(() => {
        ...
        window.addEventListener("keydown", handleStopSpeaking);
        return () => {
    ...
    const handleSendMessage = async () => {
        ...
        try {
            ...
            const reply = aiData[0]?.generated_text?.split("AI:")[1]?.trim() || "No response";
        ...
        return parts.map((part, i) =>
            i % 2 === 0 ? (
                ...
                <div key={i} className="relative my-2">
                    ...
                    <SyntaxHighlighter language="javascript" style={oneDark} customStyle={{ borderRadius: "0.5rem", padding: "1rem" }}>
                        {parts[i]}
                    </SyntaxHighlighter>
                </div>
            )
    ...
    return (
        <div className="fixed inset-0 bg-[#0f172a] text-white flex flex-col">
